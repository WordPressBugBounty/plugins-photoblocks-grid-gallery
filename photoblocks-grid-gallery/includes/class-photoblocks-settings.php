	...
	private function setup_fields() {
		...
		if ( photob_fs()->is_plan_or_trial__premium_only( 'ultimate' ) ) {
			$this->add_field(
				'gallery',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'Post IDs', 'photoblocks' ),
				'source_post_ids',
				'text',
				array(
					'default'     => '',
					'description' => esc_html__( 'Insert the IDs of the posts you want to fetch', 'photoblocks' ),
					'render'      => false,
				)
			);
			...
			$this->add_field(
				'gallery',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'Post types', 'photoblocks' ),
				'source_post_types',
				'checkbox',
				array(
					...
					'default'         => '',
					'default_premium' => '',
					'description'     => esc_html__( 'Check the post type you want to fetch.', 'photoblocks' ),
					'render'          => false,
				)
			);
			...
			$this->add_field(
				'gallery',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'Sort order', 'photoblocks' ),
				'source_post_sort',
				'select',
				array(
					'values'          => array(
						'asc'  => esc_html__( 'Ascending: older posts first', 'photoblocks' ),
						'desc' => esc_html__( 'Descending: newer posts first', 'photoblocks' ),
						'rand' => esc_html__( 'Random', 'photoblocks' ),
					),
					'default'         => 'desc',
					'default_premium' => 'desc',
					'description'     => '',
					'render'          => false,
				)
			);
			...
			$this->add_field(
				'gallery',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'Taxonomies', 'photoblocks' ),
				'source_post_taxonomies',
				'checkbox',
				array(
					'values'          => $this->get_taxonomies(),
					'default'         => '',
					'default_premium' => '',
					'description'     => esc_html__( 'Taxonomies to include', 'photoblocks' ),
					'render'          => false,
				)
			);
			...
			$this->add_field(
				'gallery',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'Taxonomy operator', 'photoblocks' ),
				'source_post_op',
				'select',
				array(
					'description'     => esc_html__( 'Whether to get all posts that match all the conditions or even only one', 'photoblocks' ),
					'values'          => array(
			...
			$this->add_field(
				'gallery',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'Only posts with featured image', 'photoblocks' ),
				'source_post_featured',
				'toggle',
				array(
					'description' => '',
					'default'     => '1',
			...
			$this->add_field(
				'gallery',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'Max posts', 'photoblocks' ),
				'source_post_max',
				'number',
				array(
					'default'         => '',
					'default_premium' => '',
					'description'     => esc_html__( 'Enter the number of posts you want to show. Leave empty for unlimited.', 'photoblocks' ),
					'render'          => false,
				)
			);
		}
		...
		if ( photob_fs()->is_plan_or_trial__premium_only( 'ultimate' ) ) {
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Background color', 'photoblocks' ),
				'block_text_background_color',
				'color',
				array(
					'description' => '',
					'default'     => '#fff',
			...
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Text color', 'photoblocks' ),
				'block_text_color',
				'color',
				array(
					'description' => '',
			...
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Title size', 'photoblocks' ),
			...
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Title vertical alignment', 'photoblocks' ),
				'block_text_title_position_v',
				'select',
				array(
					'values'  => array(
			...
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Title horizontal alignment', 'photoblocks' ),
				'block_text_title_position_h',
				'select',
				array(
					'values'  => array(
			...
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Description size', 'photoblocks' ),
			...
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Description vertical alignment', 'photoblocks' ),
				'block_text_description_position_v',
				'select',
				array(
					'values'  => array(
						'top'    => esc_html__( 'Top', 'photoblocks' ),
			...
			$this->add_field(
				'gallery',
				esc_html__( 'Text blocks', 'photoblocks' ),
				esc_html__( 'Description horizontal alignment', 'photoblocks' ),
				'block_text_description_position_h',
				'select',
				array(
					'values'  => array(
						'left'   => esc_html__( 'Left', 'photoblocks' ),
		...
		foreach ( PhotoBlocks_Utils::list_thumbnail_sizes() as $s => $item ) {
			$this->fields['gallery']['Advanced']['fields']['image_size']['values'][ $s ] =
					$s . ' (' . $item[0] . 'x' . $item[1] . ')';
		}
		...
		foreach ( PhotoBlocks_Utils::list_thumbnail_sizes() as $s => $item ) {
			$this->fields['lightbox']['Aspect']['fields']['lightbox_image_size']['values'][ $s ] =
					$s . ' (' . $item[0] . 'x' . $item[1] . ')';
		}
		...
		if ( photob_fs()->can_use_premium_code__premium_only() ) {
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Enable infinite gallery navigation', 'photoblocks' ),
					'fancybox_loop',
					'toggle',
					array(
						'show_if' => 'lightbox || lightbox_mobile == fancybox',
				...
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Enable slideshow', 'photoblocks' ),
					'fancybox_slideshow',
					'toggle',
					array(
						'show_if' => 'lightbox || lightbox_mobile == fancybox',
				...
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Enable fullscreen view', 'photoblocks' ),
					'fancybox_fullscreen',
					'toggle',
					array(
						'show_if' => 'lightbox || lightbox_mobile == fancybox',
				...
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Enable thumbnails', 'photoblocks' ),
					'fancybox_thumbnails',
					'toggle',
					array(
						'show_if' => 'lightbox || lightbox_mobile == fancybox',
				...
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Enable zoom', 'photoblocks' ),
					'fancybox_zoom',
					'toggle',
					array(
						'show_if' => 'lightbox || lightbox_mobile == fancybox',
				...
				$this->add_field(
					'lightbox',
					'Features',
					esc_html__( 'Keyboard navigation', 'photoblocks' ),
					'fancybox_keyboard',
					'toggle',
					array(
						'show_if'     => 'lightbox || lightbox_mobile == fancybox',
						'description' => esc_html__( 'Enable keyboard navigation', 'photoblocks' ),
						'default'     => '1',
					)
				);
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Arrows navigation', 'photoblocks' ),
					'fancybox_arrows',
					'toggle',
					array(
						'show_if'     => 'lightbox || lightbox_mobile == fancybox',
						'description' => esc_html__( 'Should display navigation arrows at the screen edges', 'photoblocks' ),
						'default'     => '1',
					)
				);
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Show infobar', 'photoblocks' ),
					'fancybox_infobar',
					'toggle',
					array(
						'show_if'     => 'lightbox || lightbox_mobile == fancybox',
						'description' => esc_html__( 'Should display infobar (counter and arrows at the top)', 'photoblocks' ),
						'default'     => '1',
					)
				);
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Show toolbar', 'photoblocks' ),
					'fancybox_toolbar',
					'toggle',
					array(
						'show_if'     => 'lightbox || lightbox_mobile == fancybox',
						'description' => esc_html__( 'Should display toolbar (buttons at the top)', 'photoblocks' ),
						'default'     => '1',
					)
				);
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Download button', 'photoblocks' ),
					'fancybox_download',
					'toggle',
					array(
						'show_if' => 'lightbox || lightbox_mobile == fancybox',
				...
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Social sharing', 'photoblocks' ),
					'fancybox_social',
					'toggle',
					array(
						'show_if' => 'lightbox || lightbox_mobile == fancybox',
				...
				$this->add_field(
					'lightbox',
					esc_html__( 'Features', 'photoblocks' ),
					esc_html__( 'Protect from download', 'photoblocks' ),
					'fancybox_protect',
					'toggle',
					array(
						'show_if'     => 'lightbox || lightbox_mobile == fancybox',
						'description' => esc_html__( 'It is possible to protect images from downloading by right-click. While this does not protect from truly determined users, it should discourage the vast majority from ripping off your files.', 'photoblocks' ),
						'default'     => '1',
					)
				);
		}
		...
		$this->add_field( 'customisations', esc_html__( 'General', 'photoblocks' ), '', 'custom_css_help', 'help_custom_css', array() );
		$this->add_field(
			'customisations',
			esc_html__( 'General', 'photoblocks' ),
		...
		if ( photob_fs()->is_plan_or_trial__premium_only( 'ultimate' ) ) {
			...
			*/
			$this->add_field(
				'filters',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( 'List of filters', 'photoblocks' ),
				'filters',
				'dynamic_list',
				array(
					'description' => esc_html__( 'After you add new filters, save the gallery in order to be able to assign filters to the images', 'photoblocks' ),
					'default'     => '',
				)
			);
			$this->add_field(
				'filters',
				esc_html__( 'General', 'photoblocks' ),
				esc_html__( "Translation for 'All'", 'photoblocks' ),
				'filters_all',
				'text',
				array(
					'default' => 'All',
			...
			$this->add_field(
				'filters',
				esc_html__( 'Aspect', 'photoblocks' ),
				esc_html__( 'Position', 'photoblocks' ),
				'filters_position',
				'select',
				array(
					'values'  => array(
			...
			$this->add_field(
				'filters',
				esc_html__( 'Aspect', 'photoblocks' ),
				esc_html__( 'Style', 'photoblocks' ),
				'filters_style',
				'select',
				array(
					'values'  => array(
						'boxed'      => esc_html__( 'Boxed', 'photoblocks' ),
						'underlined' => esc_html__( 'Underlined', 'photoblocks' ),
					),
					'default' => 'boxed',
				)
			);
			$this->add_field(
				'filters',
				esc_html__( ' Aspect', 'photoblocks' ),
				esc_html__( 'Selection color', 'photoblocks' ),
				'filters_color',
				'color',
				array(
					'default' => '#444',
